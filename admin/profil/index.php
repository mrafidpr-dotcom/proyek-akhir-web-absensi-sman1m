...
<head>
    ...
    <title>Profil Admin - SMAN 1  MEGAMENDUNG</title>
                    ...
                    <div class="glass-effect rounded-xl p-4 lg:p-6 lg:col-span-2 form-container">
                        ...
                        <form method="POST" enctype="multipart/form-data" class="mobile-form-spacing">
                            ...
                            <div class="flex justify-end">
                                <button type="submit" name="update_profile" class="px-6 py-2.5 bg-blue-600 hover:bg-blue-700 rounded-lg font-medium text-white transition-colors mobile-touch-target btn-hover-effect">
