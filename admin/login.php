...
<head>
    ...
    <title>Login Admin - SMAN 1  MEGAMENDUNG</title>
...
<body class="bg-gray-900 min-h-screen flex items-center justify-center bg-[url('../assets/default/bg-pattern.png')] bg-repeat">
    ...
    <div class="fixed inset-0 bg-gradient-to-br from-blue-900/50 to-gray-900/50 pointer-events-none"></div>
    ...
    <div class="max-w-md w-full mx-4 relative z-10">
        ...
        <div class="text-center mb-8">
            ...
            <h2 class="text-3xl font-bold text-white mb-2 text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-blue-600">
                Login Admin
            </h2>
            <p class="text-gray-400">Sistem Absensi SMAN 1  MEGAMENDUNG</p>
        </div>

        <!-- Login Form -->
        <div class="glass-effect rounded-xl shadow-2xl p-8 shadow-blue-900/20">
            <?php if ($error): ?>
            ...
            <form method="POST" class="space-y-6">
                <div class="space-y-4">
                    <div class="group">
                        ...
                        <input type="text" name="username" required
                            class="w-full px-5 py-4 rounded-lg bg-gray-800/80 border border-blue-500/30 text-white 
                    ...
                    <div class="group">
                        ...
                        <div class="relative">
                            ...
                            <button type="button" onclick="togglePassword()"
                                class="absolute right-4 top-1/2 -translate-y-1/2 text-gray-400 hover:text-blue-500
                ...
                <button type="submit"
                    class="w-full bg-gradient-to-r from-blue-600 to-blue-800 text-white font-medium py-4 px-4 
                    rounded-lg transition duration-300 hover:opacity-90 transform hover:-translate-y-0.5
                    focus:outline-none focus:ring-2 focus:ring-blue-500/20 flex items-center justify-center
