...
if ($format === 'excel') {
    ...
    $spreadsheet->getProperties()
        ->setCreator('SMAN 1 MEGAMENDUNG Absensi System')
        ->setLastModifiedBy('SMAN 1 MEGAMENDUNG Admin')
        ->setTitle($title)
        ->setSubject('Attendance Report')
        ->setDescription('Attendance report generated by SMAN 1 MEGAMENDUNG Absensi System');
    ...
    $sheet->setCellValue('A2', 'SMAN 1  MEGAMENDUNG');
    ...
    // Add footer
    $row += 2;
    $sheet->setCellValue('A' . $row, 'Laporan ini digenerate secara otomatis dari Sistem Absensi SMAN 1  MEGAMENDUNG');
    $sheet->mergeCells('A' . $row . ':G' . $row);
    ...
    $logoPath = $_SERVER['DOCUMENT_ROOT'] . '/e:/Faiz Sekolah/O/web-Absensi/assets/default/sman1m.png.png';
    ...
    <body>
        <div class="header">
            <div class="header-content">
                <img class="logo" src="' . $logoData . '" alt="SMAN 1  MEGAMENDUNG">
                <div class="header-text">
                    <h1>LAPORAN ABSENSI SISWA</h1>
                    <h2>SMAN 1  MEGAMENDUNG</h2>
                </div>
            </div>
        </div>
