...
<head>
    ...
    <title>Detail Absensi - SMAN 1  MEGAMENDUNG</title>
    ...
    <main class="lg:ml-64 min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 transition-all duration-300">
        ...
        <div class="lg:hidden bg-gray-900/60 backdrop-blur-lg sticky top-0 z-30 px-4 py-3 flex items-center justify-between border-b border-blue-900/30">
            ...
            <div class="flex items-center gap-3">
                ...
                $photo_path = $_SESSION['admin_photo'] ?? '/web-absensi-sman1m/="/assets/default/avatar.png';
                ?>
            ...
            <div class="max-w-4xl mx-auto">
                ...
                <div class="glass-effect rounded-xl p-4 md:p-6 mb-6 animate-fade-in">
                    <div class="flex flex-col sm:flex-row items-center sm:items-start gap-4 md:gap-6">
                        <div class="relative">
                            <img src="/web-absensi-sman1m/assets/default/avatar.png<?= htmlspecialchars($absensi['foto_profil'] ?: 'assets/default/avatar.png') ?>"
                                alt="<?= htmlspecialchars($absensi['nama_lengkap']) ?>"
                                class="w-20 h-20 md:w-24 md:h-24 rounded-xl object-cover border border-blue-500/30">
                            ...
                            <?php if ($absensi['bukti_foto']): ?>
                                <div>
                                    ...
                                    <a href="../../<?= htmlspecialchars($absensi['bukti_foto']) ?>"
                                        ...
                                        <div class="mt-2 flex justify-center items-center text-xs text-blue-400">
