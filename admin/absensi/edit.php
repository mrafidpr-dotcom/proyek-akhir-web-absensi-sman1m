...
<head>
    ...
    <title>Edit Absensi - SMAN 1  MEGAMENDUNG</title>
                    ...
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-6">
                            ...
                            <textarea id="keterangan" name="keterangan" rows="3"
                                class="w-full bg-gray-800/50 border border-gray-700 rounded-lg px-3 py-3 text-white focus:outline-none focus:border-blue-500 touch-target"><?= htmlspecialchars($absensi['keterangan']) ?></textarea>
                        </div>
