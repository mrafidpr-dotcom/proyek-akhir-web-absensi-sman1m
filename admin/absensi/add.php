...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        $sql = "INSERT INTO absensi (siswa_id, status, tanggal, jam_masuk, keterangan, approval_status) 
                VALUES (:siswa_id, :status, :tanggal, :jam_masuk, :keterangan, :approval_status)";
        ...
        if (isset($_FILES['bukti_file']) && $_FILES['bukti_file']['error'] == 0) {
            ...
            $new_filename = 'file_' . time() . '_' . $siswa_id . '.' . $file_extension;
        ...
        $sql = "SELECT nama_lengkap FROM siswa WHERE id = :id";
        $stmt = $conn->prepare($sql);
        ...
        $stmt->execute([
            ...
            'description' => "Admin menambahkan absensi " . $status . " untuk " . $siswa['nama_lengkap'] . " pada tanggal " . date('d/m/Y', strtotime($tanggal))
        ]);
...
<head>
    ...
    <title>Tambah Absensi - SMAN 1  MEGAMENDUNG</title>
    ...
    <main class="lg:ml-64 min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 transition-all duration-300">
        ...
        <div class="lg:hidden bg-gray-900/60 backdrop-blur-lg sticky top-0 z-30 px-4 py-3 flex items-center justify-between border-b border-blue-900/30">
            ...
            <div class="flex items-center gap-3">
                ...
                ?>
                <img src="/web-absensi-sman1m/assets/default/avatar.png" alt="Profile" class="h-8 w-8 rounded-full object-cover border border-blue-500/50">
            </div>
        </div>
                    ...
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-6">
                            ...
                            <select id="siswa_id" name="siswa_id" required
                                class="w-full bg-gray-800/50 border border-gray-700 rounded-lg px-3 py-3 md:py-2 text-white focus:outline-none focus:border-blue-500 touch-target">
                            ...
                            <div class="mt-2 lg:hidden">
                                <input type="text" id="studentSearch" placeholder="Cari siswa..."
                                    class="w-full bg-gray-800/50 border border-gray-700 rounded-lg px-3 py-3 text-white focus:outline-none focus:border-blue-500">
                            </div>
                        </div>
                        ...
                        <div class="my-6">
                            ...
                            <textarea id="keterangan" name="keterangan" rows="3" placeholder="Masukkan keterangan atau alasan jika diperlukan"
                                class="w-full bg-gray-800/50 border border-gray-700 rounded-lg px-3 py-3 text-white focus:outline-none focus:border-blue-500"></textarea>
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <div class="relative">
                                ...
                                <button type="button" onclick="document.getElementById('bukti_file').click()"
                                    class="absolute right-2 top-1/2 -translate-y-1/2 px-3 py-1 bg-blue-600/80 hover:bg-blue-600 rounded text-sm">
                                    Browse
                                </button>
                            </div>
                        ...
                        <div class="flex justify-end">
                            <button type="submit" class="w-full md:w-auto px-6 py-3 md:py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors font-medium">
