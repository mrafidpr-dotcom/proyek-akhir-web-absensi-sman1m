...
<head>
    ...
    <title>Data Absensi - SMAN 1  MEGAMENDUNG</title>
    ...
    <aside id="sidebar" class="fixed top-0 left-0 h-screen w-64 glass-effect border-r border-blue-900/30 z-50 sidebar-transition -translate-x-full lg:translate-x-0">
        <div class="flex items-center justify-between p-4 lg:p-6 border-b border-blue-900/30">
            <div class="flex items-center gap-3">
                <img src="/web-absensi-sman1m/assets/default/logo-sman1m.png" alt="SMAN 1 MEGAMENDUNG" class="h-10 w-auto">
                <div>
    ...
    <main class="lg:ml-64 min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 transition-all duration-300">
        ...
        <div class="lg:hidden bg-gray-900/60 backdrop-blur-lg sticky top-0 z-30 px-4 py-3 flex items-center justify-between border-b border-blue-900/30">
            ...
            <div class="flex items-center gap-3">
                ...
                $photo_path = $_SESSION['admin_photo'] ?? '/web-absensi-sman1m/assets/default/photo-profile.png';
                ?>
                <img src="../../<?= $photo_path ?>" alt="Profile" class="h-8 w-8 rounded-full object-cover border border-blue-500/50">
            </div>
        </div>
        ...
        <div class="p-4 lg:p-8">
            <div class="max-w-7xl mx-auto">
                ...
                <header class="flex flex-wrap justify-between items-center mb-6 gap-4">
                    ...
                    <div>
                        <a href="add.php" class="px-4 py-2 bg-blue-600 hover:bg-blue-700 rounded-lg flex items-center gap-2 text-sm font-medium transition-colors">
                ...
                <div class="glass-effect rounded-xl p-4 md:p-6 mb-6">
                    <div class="flex flex-wrap justify-between items-center mb-4">
                        ...
                        <?php if (!empty($_GET) && isset($_GET['search']) || isset($_GET['date']) || isset($_GET['status']) || isset($_GET['kelas']) || isset($_GET['jurusan']) || isset($_GET['approval'])): ?>
                            <a href="index.php" class="text-sm flex items-center gap-1 text-blue-400 hover:text-blue-300">
                    ...
                    <form method="GET" id="filterForm">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-4">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <select name="status" class="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2.5 text-sm text-white focus:outline-none focus:border-blue-500">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <select name="kelas" class="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2.5 text-sm text-white focus:outline-none focus:border-blue-500">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <select name="jurusan" class="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2.5 text-sm text-white focus:outline-none focus:border-blue-500">
                                        <option value="">Semua Jurusan</option>
                                        <option value="IPA" <?= $jurusan_filter === 'IPA' ? 'selected' : '' ?>>IPA</option>
                                        <option value="IPS" <?= $jurusan_filter === 'IPS' ? 'selected' : '' ?>>IPS</option>
                                    </select>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <select name="approval" class="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2.5 text-sm text-white focus:outline-none focus:border-blue-500">
                                        <option value="">Semua Status</option>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="text" name="search" value="<?= htmlspecialchars($search) ?>"
                                        ...
                                        class="w-full bg-gray-800 border border-gray-700 rounded-lg pl-9 pr-9 py-2.5 text-sm text-white focus:outline-none focus:border-blue-500">
                        ...
                        <div class="mt-6 flex justify-end">
                            <button type="submit" class="px-5 py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors text-sm">
                ...
                <div class="glass-effect rounded-xl overflow-hidden">
                            ...
                            <table class="w-full whitespace-nowrap">
                                ...
                                <tbody class="divide-y divide-gray-800">
                                    <?php foreach ($absensi_list as $absensi): ?>
                                        <tr class="hover:bg-blue-900/5 transition-colors animate-fade-in">
                                            <td class="px-6 py-4">
                        ...
                        <div class="p-4 border-t border-gray-800 flex flex-col sm:flex-row justify-between items-center gap-4">
                            ...
                            <div class="flex space-x-1 order-1 sm:order-2 pagination-compact">
                                ...
                                for ($i = $start_page; $i <= $end_page; $i++) {
                                    $is_current = $i == $page;
                                    $class = $is_current
                                        ? 'px-2 sm:px-3 py-1.5 bg-blue-600 rounded text-white text-sm flex items-center justify-center min-w-[32px] current-page page-number'
                    ...
                    <?php else: ?>
                        <div class="p-10 text-center">
                            ...
                            <?php if (!empty($_GET)): ?>
                                <a href="index.php" class="mt-4 inline-block text-blue-400 hover:text-blue-500">
                ...
                <div class="fixed bottom-4 right-4 lg:hidden">
                    <a href="add.php" class="flex items-center justify-center w-14 h-14 bg-blue-600 hover:bg-blue-700 rounded-full shadow-lg transition-colors">
