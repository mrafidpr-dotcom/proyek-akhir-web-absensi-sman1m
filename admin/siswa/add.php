...
<head>
    ...
    <title>Tambah Siswa - SMAN 1  MEGAMENDUNG</title>
                    ...
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-6 text-center">
                            <div class="relative w-28 h-28 md:w-32 md:h-32 mx-auto">
                                <img id="preview-image" src="../../assets/default/avatar.png"
                                    alt="Profile" class="w-28 h-28 md:w-32 md:h-32 object-cover rounded-full border-4 border-gray-800">

                                <label for="foto_profil" class="absolute -bottom-2 -right-2 bg-blue-600 hover:bg-blue-700 rounded-full w-9 h-9 md:w-10 md:h-10 flex items-center justify-center cursor-pointer transition-colors profile-upload">
                            ...
                            <div class="mb-2 md:mb-0">
                                ...
                                <div class="relative">
                                    <input type="password" id="password" name="password"
                                        ...
                                        class="w-full bg-gray-800/50 border border-gray-700 rounded-lg px-3 py-3 md:py-2 pr-10 text-white focus:outline-none focus:border-blue-500 touch-target">
