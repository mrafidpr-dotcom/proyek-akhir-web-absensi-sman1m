...
<head>
    ...
    <title>Detail Siswa - SMAN 1  MEGAMENDUNG</title>
    ...
    <main class="lg:ml-64 min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 transition-all duration-300">
        ...
        <div class="lg:hidden bg-gray-900/60 backdrop-blur-lg sticky top-0 z-30 px-4 py-3 flex items-center justify-between border-b border-blue-900/30">
            ...
            <div class="flex items-center gap-3">
                ...
                $photo_path = $_SESSION['admin_photo'] ?? 'assets/default/photo-profile.png';
                ?>
                <img src="/web-Absensi-sman1m/assets/default/photo-profile.png"<?= $photo_path ?>" alt="Profile" class="h-8 w-8 rounded-full object-cover border border-blue-500/50">
            </div>
        </div>
            ...
            <div class="max-w-7xl mx-auto">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6 mb-6">
                    ...
                    <div class="glass-effect rounded-xl overflow-hidden">
                        ...
                        <div class="h-24 sm:h-32 bg-gradient-to-r from-blue-600/30 to-blue-600/30 relative"></div>
                        ...
                        <div class="px-4 sm:px-6 pb-5 sm:pb-6 -mt-12 sm:-mt-14 relative">
                            ...
                            <img src="/web-Absensi-sman1m/assets/default/photo-profile.png"<?= $siswa['foto_profil'] ?>
                            ...
                            <div class="space-y-2 sm:space-y-3">
                                <div class="flex items-center gap-3">
                                    <i class="fas fa-envelope w-5 text-center text-blue-500"></i>
                                    <span class="text-sm break-all"><?= htmlspecialchars($siswa['email']) ?></span>
                                </div>
                                <div class="flex items-center gap-3">
                                    <i class="fas fa-clock w-5 text-center text-blue-500"></i>
